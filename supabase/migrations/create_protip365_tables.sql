-- ProTip365 Database Tables Creation Script
...
-- Create v_shift_income view (this is what was showing as unrestricted)
...
SELECT 
    ...
    CASE 
        WHEN si.actual_hours > 0 THEN (si.hourly_rate * si.actual_hours)
        ELSE 0
    END as hourly_wage,
    -- Calculate total earnings
    CASE 
        WHEN si.actual_hours > 0 THEN (si.hourly_rate * si.actual_hours) + (si.sales + si.tips + si.other - si.cash_out)
        ELSE (si.sales + si.tips + si.other - si.cash_out)
