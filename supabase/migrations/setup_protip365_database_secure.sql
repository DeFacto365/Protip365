-- ProTip365 Database Setup Script (Security Fixed Version)
...
-- Create v_shift_income view (WITHOUT SECURITY DEFINER for security compliance)
...
-- Note: Views inherit RLS from underlying tables, so v_shift_income will automatically
-- respect the RLS policies on shift_income and employers tables
