-- Fix v_shift_income security issue - WORKING VERSION
-- Based on the actual view structure shown in the image

-- Drop the existing view with SECURITY DEFINER
DROP VIEW IF EXISTS public.v_shift_income;

-- Recreate the view WITHOUT SECURITY DEFINER
-- Using the actual column structure from the existing view
...
SELECT 
    ...
    si.created_at,
    si.updated_at,
    -- These columns DO exist in the view as shown in the image
    si.employer_id,
