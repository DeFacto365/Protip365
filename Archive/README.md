...
This folder keeps inactive project material out of the active workspace while preserving it for reference.
...
- `docs/Docs-Archives/` - older documentation archives formerly under `Docs/Archives`.
- `docs/legacy-root-docs/` - legacy native iOS/Android implementation notes, screenshots, setup guides, old validation notes, and sample/reference docs formerly under root `Docs/`.
- `docs/legacy-website-material/` - unused website templates, demo assets, WordPress exports, and older ProTip365 landing page variants.
- `tools/browser-tools-mcp-reference.md` - archived reference to the old browser tooling checkout, not part of the app source.
