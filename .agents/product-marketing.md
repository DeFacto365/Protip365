...
**Direct:** ServerLife, Just The Tips, Tip Tracker, TipShift, Waiter Pal, TipKeepr, TipMax, Checkout, Tableside Tip Tracker.
**Secondary:** Spreadsheets, notes apps, personal finance apps, payroll screenshots.
**Indirect:** Doing nothing, memory, paper slips, POS receipt piles.
...
- "I can see what I made tonight."
**Words to use:** tips, shifts, real hourly rate, cash tips, card tips, tip-out, server, bartender, waiter, waitress, clean records.
**Words to avoid:** ultimate, powerful, comprehensive, maximize without proof, guaranteed earnings, end-to-end encryption unless verified.
**Glossary:**
| Term | Meaning |
|------|---------|
| Tip-out | Money shared with support staff or team members after a shift |
| Real hourly rate | Total shift income divided by hours worked |
| Clean records | Organized shift and income history inside the app |

## Brand Voice
**Tone:** Direct, practical, worker-first.
**Style:** Plain language, benefit-led, no hype.
